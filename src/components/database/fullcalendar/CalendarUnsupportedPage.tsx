  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 max-sm:py-6 px-4">
      ...
      <p className="text-text-caption text-center mb-8 max-w-md">
        Calendar view is not supported on this device. For the best calendar experience, please download the {BRAND.name} mobile app.
      </p>
      
      {/* Buttons */}
      <div className="flex flex-col max-sm:w-full sm:flex-row gap-3">
        <Button
          onClick={() => window.open(`${BRAND.url}/download`, '_blank')}
        >
          {`Download ${BRAND.name}`}
        </Button>
        <Button
